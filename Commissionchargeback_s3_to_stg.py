...
S3bucket_node1 = glueContext.create_dynamic_frame.from_catalog(
    database="eds_db",
    table_name="commissionchargeback_csv",
...
datasink5  = glueContext.write_dynamic_frame.from_jdbc_conf(
    ...
    connection_options = {"preactions":"truncate table eds_stg.commission_charge_back;","dbtable":"eds_stg.commission_charge_back", "database":"dev", "postactions":"update eds_stg.file_control set status = 'S' where filename like 'CommissionChargeback%' and CYCLE_DATE in(select to_char(current_date,'YYYYMMDD'))"},
